            ...
            <div class="mb-8">
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    ...
                    <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full sm:w-auto">
                        <form method="GET" action="{{ route('intern.microskill.index') }}"
                            ...
                            @if (request('q'))
                                <a href="{{ route('intern.microskill.index') }}" aria-label="Bersihkan pencarian"
                                    class="w-11 h-11 rounded-full bg-white border border-gray-200 text-gray-600 flex items-center justify-center hover:bg-gray-50">
                                    <i class="fas fa-times"></i>
                                </a>
                            @else
                                <button type="submit" aria-label="Cari"
                                    class="w-11 h-11 rounded-full bg-blue-600 text-white flex items-center justify-center hover:bg-blue-700">
                                    ...
                                    <tr class="hover:bg-blue-50 transition-colors duration-150">
                                        <td class="px-6 py-4 whitespace-nowrap text-left">
                                            <div class="flex items-center justify-start min-w-0">
                                                <span
                                                    class="text-sm font-medium text-gray-900 truncate">{{ $s->title }}</span>
                                            </div>
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-center">
                                            <div class="flex space-x-2 justify-center">
                                                ...
                                                <form action="{{ route('intern.microskill.destroy', $s->id) }}"
