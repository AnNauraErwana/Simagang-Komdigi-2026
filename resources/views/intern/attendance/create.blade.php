        ...
        <div class="bg-white shadow rounded-lg p-6">
            ...
            <form method="POST" action="{{ route('intern.attendance.store') }}" enctype="multipart/form-data"
                ...
                <div id="hadirSection" class="hidden mb-6">
                    ...
                    <div class="mb-4">
                        <video id="video" width="100%" height="auto" class="border rounded-lg hidden" autoplay
                            playsinline style="transform: scaleX(-1);"></video>
                        <canvas id="canvas" class="hidden"></canvas>
                        <img id="capturedImage" class="w-full max-w-md mx-auto border rounded-lg hidden mb-4"
                            alt="Captured image">
                    </div>
                ...
                <div id="izinSakitSection" class="hidden mb-6">
                    ...
                    <div>
                        <label for="document" class="block text-sm font-medium text-gray-700 mb-2">Upload Dokumen
                            Pendukung</label>
