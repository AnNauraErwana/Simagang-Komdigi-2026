        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden mb-8">
                <div class="bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-8">
                    <div
                        class="flex flex-col md:flex-row items-center md:items-start justify-between space-y-4 md:space-y-0">
                        <div
                            ...
                            @else
                                <div
                                    class="w-32 h-32 rounded-full bg-gradient-to-br from-blue-400 to-indigo-500 flex items-center justify-center border-4 border-white shadow-lg">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4 md:gap-6 mb-8">
                <!-- Card 1: Hari Hadir -->
                <div
                    class="bg-white rounded-xl sm:rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group flex flex-col h-full">
                    <div class="p-3 sm:p-6 flex-1">
                        <div
                            class="flex flex-col-reverse sm:flex-row items-center sm:items-start justify-center sm:justify-between gap-2 sm:gap-3">
                            ...
                            <div
                                class="flex-shrink-0 w-10 h-10 sm:w-16 sm:h-16 bg-blue-500 rounded-xl sm:rounded-2xl flex items-center justify-center transform group-hover:scale-110 transition-transform duration-300">
                ...
                <div
                    ...
                    <div class="p-3 sm:p-6 flex-1">
                        <div
                            ...
                            <div
                                class="flex-shrink-0 w-10 h-10 sm:w-16 sm:h-16 bg-yellow-500 rounded-xl sm:rounded-2xl flex items-center justify-center transform group-hover:scale-110 transition-transform duration-300">
                ...
                <div
                    ...
                    <div class="p-3 sm:p-6 flex-1">
                        <div
                            ...
                            <div
                                class="flex-shrink-0 w-10 h-10 sm:w-16 sm:h-16 bg-red-500 rounded-xl sm:rounded-2xl flex items-center justify-center transform group-hover:scale-110 transition-transform duration-300">
                    ...
                    <div class="p-3 sm:p-6 flex-1">
                        <div
                            ...
                            <div class="flex-1 min-w-0 flex flex-col text-center sm:text-left">
                                ...
                                <dd class="text-lg sm:text-2xl font-bold text-gray-900 truncate">{{ $totalTidakHadir }}
                                </dd>
                            </div>
                            <div
                                class="flex-shrink-0 w-10 h-10 sm:w-16 sm:h-16 bg-orange-500 rounded-xl sm:rounded-2xl flex items-center justify-center transform group-hover:scale-110 transition-transform duration-300">
                    ...
                    <div class="p-3 sm:p-6 flex-1">
                        <div
                            ...
                            <div class="flex-1 min-w-0 flex flex-col text-center sm:text-left">
                                ...
                                <dd class="text-lg sm:text-2xl font-bold text-gray-900 truncate">
                                    {{ $hasFinalReport ? 'Sudah' : 'Belum' }}</dd>
                            </div>
                            <div
                                class="flex-shrink-0 w-10 h-10 sm:w-16 sm:h-16 bg-green-500 rounded-xl sm:rounded-2xl flex items-center justify-center transform group-hover:scale-110 transition-transform duration-300">
                    ...
                    <div class="p-3 sm:p-6 flex-1">
                        <div
                            ...
                            <div class="flex-1 min-w-0 flex flex-col text-center sm:text-left">
                                ...
                                <dd class="text-lg sm:text-2xl font-bold text-gray-900 truncate">
                                    {{ $microSkillApproved }}/{{ $microSkillTotal }}</dd>
                            </div>
                            <div
                                class="flex-shrink-0 w-10 h-10 sm:w-16 sm:h-16 bg-purple-500 rounded-xl sm:rounded-2xl flex items-center justify-center transform group-hover:scale-110 transition-transform duration-300">
                            ...
                            <div class="space-y-3">
                                ...
                                @if ($todayAttendance->status == 'hadir')
                                    <div class="flex items-center justify-between">
                                        ...
                                        <span
                                            class="text-gray-900 font-medium">{{ $todayAttendance->check_in ? \Carbon\Carbon::parse($todayAttendance->check_in)->format('H:i') : '-' }}</span>
                                    </div>
                                    <div class="flex items-center justify-between">
                                        <span class="text-gray-700">Check Out:</span>
                                        <span
                                            class="text-gray-900 font-medium">{{ $todayAttendance->check_out ? \Carbon\Carbon::parse($todayAttendance->check_out)->format('H:i') : '-' }}</span>
                                    </div>
                                    @if (!$todayAttendance->check_out)
                                        <button
                                            onclick="document.getElementById('checkoutModal').classList.remove('hidden')"
                ...
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                    ...
                    <div class="p-6 space-y-3">
                        <a href="{{ route('intern.attendance.index') }}"
                            class="block w-full p-3 bg-blue-50 hover:bg-blue-100 text-blue-700 font-medium rounded-lg transition-all duration-300 border border-blue-200 hover:border-blue-300">
                            <i class="fas fa-calendar-check mr-2"></i>Riwayat Absensi
                        </a>
                        <a href="{{ route('intern.logbook.index') }}"
                            class="block w-full p-3 bg-green-50 hover:bg-green-100 text-green-700 font-medium rounded-lg transition-all duration-300 border border-green-200 hover:border-green-300">
                            <i class="fas fa-book mr-2"></i>Logbook Harian
                        </a>
                        <a href="{{ route('intern.report.index') }}"
                            class="block w-full p-3 bg-purple-50 hover:bg-purple-100 text-purple-700 font-medium rounded-lg transition-all duration-300 border border-purple-200 hover:border-purple-300">
    ...
    <div id="checkoutModal" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
        <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
            <div class="mt-3">
                ...
                <form action="{{ route('intern.attendance.checkout') }}" method="POST" enctype="multipart/form-data"
                    id="checkoutForm">
                    @csrf
                    <div class="mb-4">
                        <video id="checkoutVideo" width="100%" height="auto" class="border rounded-lg hidden"
                            autoplay playsinline style="transform: scaleX(-1);"></video>
                        <canvas id="checkoutCanvas" class="hidden"></canvas>
                        <img id="checkoutCapturedImage" class="w-full max-w-md mx-auto border rounded-lg hidden mb-4"
                            alt="Captured image">
                    </div>
    ...
    @push('scripts')
        <script>
            ...
            checkoutCapturePhotoBtn.addEventListener('click', function() {
                ...
                // Flip the image horizontally to match the mirrored video preview
                ...
                fetch(imageData)
                    .then(res => res.blob())
                    .then(blob => {
                        const file = new File([blob], 'checkout-photo.png', {
                            type: 'image/png'
                        });
