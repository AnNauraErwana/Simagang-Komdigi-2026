        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="hero-strip mb-6">
                <div class="relative z-10 px-6 py-7">
                    ...
                    <p class="text-blue-100">Pantau kehadiran dan aktivitas check in/out anak magang</p>
                </div>
            </div>
            ...
            <div class="panel mb-6">
                <div class="px-6 py-4 border-b">
                    <h2 class="text-lg font-semibold text-blue-900 flex items-center"><i
                            class="fas fa-filter mr-2 text-blue-600"></i>Filter & Pencarian</h2>
                </div>
                        ...
                        <select name="intern_id" id="intern_id" class="input-main">
                            ...
                            @foreach ($interns as $intern)
                                <option value="{{ $intern->id }}"
                                    {{ request('intern_id') == $intern->id ? 'selected' : '' }}>{{ $intern->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="flex items-end gap-2">
                        ...
                        @if (request()->query())
                            <a href="{{ route('admin.attendance.index') }}"
                                class="bg-blue-100 hover:bg-blue-200 text-blue-700 font-bold py-2 px-4 rounded-lg transition duration-200 flex items-center justify-center"><i
            ...
            <div class="panel overflow-hidden">
                <div class="bg-blue-600 px-6 py-4">
                    <h2 class="text-xl font-bold text-white flex items-center"><i
                            class="fas fa-calendar-check mr-3"></i>Data Absensi</h2>
                </div>
                <div class="p-6">
                            ...
                            <tbody class="bg-white divide-y divide-gray-100">
                                    ...
                                    <tr class="bg-red-50">
                                        <td class="px-6 py-4 whitespace-nowrap text-center">
                                            <div class="text-sm font-medium text-gray-900">
                                                {{ \Carbon\Carbon::parse($todayWita)->format('d/m/y') }} <span
                                                    class="text-xs text-gray-400">(Hari ini)</span></div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-center">
                                            <div class="text-sm font-medium text-gray-900">{{ $absentIntern->name }}</div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-center"><span
                                                class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-red-100 text-red-800">Tidak
                                                Hadir</span></td>
                                        <td colspan="6" class="px-6 py-4 text-sm text-gray-400 italic text-center">Belum
                                            melakukan absensi hari ini</td>
                                    </tr>
                                @endforeach
                                ...
                                @forelse($attendances as $attendance)
                                    <tr class="hover:bg-blue-50 transition-colors duration-150">
                                        <td class="px-6 py-4 whitespace-nowrap text-center">
                                            <div class="text-sm text-gray-900">{{ $attendance->date->format('d/m/y') }}
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-center">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-center">
                                            <span
                                                class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full @if ($attendance->status == 'hadir') bg-green-100 text-green-800 @elseif($attendance->status == 'izin') bg-yellow-100 text-yellow-800 @elseif($attendance->status == 'sakit') bg-orange-100 text-orange-800 @else bg-red-100 text-red-800 @endif">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-center">
                                            @if ($attendance->document_status)
                                                <span
                                                    class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full @if ($attendance->document_status == 'approved') bg-green-100 text-green-800 @elseif($attendance->document_status == 'rejected') bg-red-100 text-red-800 @else bg-yellow-100 text-yellow-800 @endif">{{ ucfirst($attendance->document_status) }}</span>
                                            @else
                                                <span class="text-gray-400">-</span>
                                            @endif
                                        </td>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="9" class="px-6 py-8 text-center">
                                            <div class="flex flex-col items-center justify-center text-gray-500"><i
                                                    class="fas fa-inbox text-4xl mb-3 text-gray-300"></i>
