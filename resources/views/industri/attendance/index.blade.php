        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            <div class="hero-strip px-6 py-7 sm:px-8 sm:py-8">
                <div class="relative z-10 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
                    <div class="max-w-3xl text-white">
                        <p class="text-xs sm:text-sm uppercase tracking-[0.3em] text-blue-100/80">Industri Dashboard</p>
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <form method="GET" action="{{ route('industri.attendance.index') }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-4 items-end">
                            ...
                            <div class="flex items-end gap-2 h-full">
                                ...
                                @if (request()->anyFilled(['intern_id', 'date_from', 'date_to', 'status']))
                                    ...
                                    <a
                                        href="{{ route('industri.attendance.index') }}"
                                ...
                                @forelse($attendances as $a)
                                    <tr class="hover:bg-blue-50 transition-colors duration-150">
                                        ...
                                        <td class="px-3 sm:px-6 py-3 sm:py-4 whitespace-nowrap">
                                            @if ($a->photo_path)
                                                @php
                                                    $photoUrl = route('industri.attendance.photo', [
                                        ...
                                        <td class="px-3 sm:px-6 py-3 sm:py-4 whitespace-nowrap">
                                            @if ($a->photo_checkout)
                                                @php
                                                    $photoCheckoutUrl = route('industri.attendance.photo', [
                                ...
                                @forelse($internStatistics as $intern)
                                    ...
                                    <tr class="hover:bg-blue-50 transition">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-center">
                                            ...
                                            <a href="{{ route('industri.attendance.show', ['intern' => $intern->id]) }}"
