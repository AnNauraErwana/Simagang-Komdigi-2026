                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 sm:gap-4 mb-3 sm:mb-4">
                        ...
                        <div class="flex items-end space-x-2 sm:col-span-2 lg:col-span-1">
                            ...
                            <a href="{{ route('mentor.attendance.index') }}" 
                               class="inline-flex items-center justify-center px-3 sm:px-4 py-2 sm:py-2.5 bg-gray-500 text-white font-semibold rounded-lg hover:bg-gray-600 shadow-md hover:shadow-lg transition-all duration-300">
                ...
                <div class="overflow-x-auto -mx-3 sm:mx-0">
                    <div class="inline-block min-w-full align-middle">
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead>
                                <tr class="bg-blue-50">
                                    <th class="px-3 sm:px-6 py-3 sm:py-4 text-left text-xs font-bold text-blue-900 uppercase tracking-wider rounded-tl-lg whitespace-nowrap">Tanggal</th>
                                    <th class="px-3 sm:px-6 py-3 sm:py-4 text-left text-xs font-bold text-blue-900 uppercase tracking-wider whitespace-nowrap">Nama</th>
                                    <th class="px-3 sm:px-6 py-3 sm:py-4 text-left text-xs font-bold text-blue-900 uppercase tracking-wider whitespace-nowrap">Status</th>
                                    <th class="px-3 sm:px-6 py-3 sm:py-4 text-left text-xs font-bold text-blue-900 uppercase tracking-wider whitespace-nowrap">Check In</th>
                                    <th class="px-3 sm:px-6 py-3 sm:py-4 text-left text-xs font-bold text-blue-900 uppercase tracking-wider whitespace-nowrap">Check Out</th>
                                    <th class="px-3 sm:px-6 py-3 sm:py-4 text-left text-xs font-bold text-blue-900 uppercase tracking-wider whitespace-nowrap">Foto In</th>
                                    <th class="px-3 sm:px-6 py-3 sm:py-4 text-left text-xs font-bold text-blue-900 uppercase tracking-wider rounded-tr-lg whitespace-nowrap">Foto Out</th>
                                </tr>
                            </thead>
                                    ...
                                    <tr class="hover:bg-blue-50 transition-colors duration-150">
                                        <td class="px-3 sm:px-6 py-3 sm:py-4 whitespace-nowrap">
                                            <div class="flex items-center text-xs sm:text-sm text-gray-900">
                                                ...
                                                <span class="hidden sm:inline">{{ \Carbon\Carbon::parse($a->date)->format('d M Y') }}</span>
                                                <span class="sm:hidden">{{ \Carbon\Carbon::parse($a->date)->format('d/m/y') }}</span>
                                            </div>
                                        </td>
                                        <td class="px-3 sm:px-6 py-3 sm:py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                ...
                                                @endif
                                                <span class="text-xs sm:text-sm font-medium text-gray-900 truncate max-w-[100px] sm:max-w-none">{{ $a->intern->name }}</span>
                                            </div>
                                        </td>
                                        <td class="px-3 sm:px-6 py-3 sm:py-4 whitespace-nowrap">
                                            <span class="px-2 sm:px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full capitalize
                                        ...
                                        <td class="px-3 sm:px-6 py-3 sm:py-4 whitespace-nowrap">
                                            @if($a->photo_path)
                                                <img src="{{ url('storage/'.$a->photo_path) }}" 
                                                     alt="Check In" 
                                        ...
                                        <td class="px-3 sm:px-6 py-3 sm:py-4 whitespace-nowrap">
                                            @if($a->photo_checkout)
                                                <img src="{{ url('storage/'.$a->photo_checkout) }}" 
                                                     alt="Check Out" 
                                                     class="w-10 h-10 sm:w-12 sm:h-12 object-cover rounded-lg border-2 border-blue-200 cursor-pointer hover:border-blue-400 transition-all shadow-sm" 
                                    ...
                                    <tr>
                                        <td colspan="7" class="px-3 sm:px-6 py-6 sm:py-8 text-center">
                                            <div class="flex flex-col items-center justify-center text-gray-500">
                                                <i class="fas fa-inbox text-4xl sm:text-5xl mb-2 sm:mb-3 text-gray-300"></i>
                                                <p class="text-xs sm:text-sm font-medium">Tidak ada data absensi.</p>
                                                <p class="text-xs text-gray-400 mt-1">Coba ubah filter untuk melihat data lainnya</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
