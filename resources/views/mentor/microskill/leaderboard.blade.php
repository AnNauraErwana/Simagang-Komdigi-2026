                ...
                <div class="p-6">
                    <div class="space-y-3">
                        @forelse($rows as $index => $row)
                            ...
                            @endphp
                            <div
                                class="flex items-center justify-between p-4 bg-gradient-to-r from-indigo-50 to-purple-50 rounded-xl hover:shadow-lg transition-all duration-300 border border-indigo-100 group">
                                    ...
                                    <div class="mr-4">
                                        @if ($row->photo_path)
                                            <img src="{{ url('storage/' . $row->photo_path) }}"
                                                class="w-14 h-14 rounded-full object-cover border-3 border-white shadow-lg ring-2 cursor-pointer hover:shadow-xl transition-all duration-300
                                             @if ($actualRank == 1) ring-yellow-400
                                             @elseif($actualRank == 2) ring-gray-400
                                             @elseif($actualRank == 3) ring-orange-400
                                             @else ring-indigo-300 @endif"
                                                alt="{{ $row->name }}"
                                                onclick="window.open('{{ url('storage/' . $row->photo_path) }}', '_blank')"
                                                title="Klik untuk melihat full size" />
                                        @else
                                            <div
                                                class="w-14 h-14 rounded-full bg-gradient-to-br from-indigo-400 to-purple-500 flex items-center justify-center shadow-lg ring-2 ring-indigo-300">
                                ...
                                <div class="ml-4">
                                    <div class="text-center">
                                        <div
                                            class="px-4 py-2 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-xl shadow-md">
