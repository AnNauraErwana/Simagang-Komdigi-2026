            ...
            <div class="bg-gradient-to-r from-purple-600 to-pink-600 px-6 py-6">
                <div class="flex items-center">
                    ...
                    <div class="text-white">
                        ...
                        <p class="text-purple-100 flex items-center mt-1">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-sm font-semibold text-gray-900">{{ $report->submitted_at ? $report->submitted_at->format('d F Y H:i') : '-' }}</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="space-y-4">
                                ...
                                @foreach($projectFilesDisplay as $pf)
                                    <div class="p-4 bg-gray-50 rounded-xl border border-gray-200">
                                        <p class="text-sm text-gray-700 font-medium mb-2">
                                            ...
                                            File Proyek {{ $loop->iteration }}: {{ data_get($pf,'name') ?? basename(data_get($pf,'path','')) }}
                                        </p>
                            ...
                            @elseif($report->project_file)
                                <div class="p-4 bg-gray-50 rounded-xl border border-gray-200">
                                    <p class="text-sm text-gray-700 font-medium mb-2">
                                        <i class="fas fa-file-archive text-gray-500 mr-2"></i>
                                        File Proyek: {{ $report?->project_file_name ?? basename($report?->project_file ?? '') }}
                                    </p>
                                ...
                                @foreach($projectLinksDisplay as $pl)
                                    ...
                                    <div class="p-4 bg-indigo-50 rounded-xl border border-indigo-200">
                                        ...
                                        <a href="{{ $pl }}" target="_blank" rel="noopener" 
                                           class="inline-flex items-center px-4 py-2 bg-indigo-600 text-white text-sm font-semibold rounded-lg hover:bg-indigo-700 shadow-sm hover:shadow-md transition-all duration-300">
        ...
        @if(!$report->grade)
                    ...
                    <form method="POST" action="{{ route('mentor.report.grade', $report) }}">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="number" name="score" id="score" min="0" max="100" required
                                class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-lg font-semibold"
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="mentor_note" id="mentor_note" rows="5" 
                                ...
                                class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">{{ old('mentor_note') }}</textarea>
                        </div>
                        ...
                        <div class="flex justify-end space-x-3">
                            ...
                            <button type="submit" 
                                    class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold rounded-xl hover:from-indigo-700 hover:to-purple-700 shadow-md hover:shadow-lg transition-all duration-300">
            ...
            <script>
                function updateGradePreview(score) {
                    ...
                    preview.innerHTML = '<i class="fas fa-trophy mr-2"></i>Nilai yang akan diberikan: <span class="text-lg">' + grade + '</span>';
